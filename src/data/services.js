export const services = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'School and sports wellness support',
    ],
    bestFor: 'Families looking for practical prevention guidance, seasonal reminders, and everyday safety education.',
    includes: [
      'Age-based prevention guidance',
      'Seasonal reminders and wellness topics',
      'Useful links to related clinic resources',
    ],
    commonQuestions: [
      {
      ...
      {
        question: 'Why keep safety as its own service page?',
        answer:
          'Because it works well as an evergreen resource center that families may revisit outside of a scheduled appointment.',
      },
    ],
    relatedLinks: ['Well Child Visits', 'Forms & Resources', 'Locations'],
  },
